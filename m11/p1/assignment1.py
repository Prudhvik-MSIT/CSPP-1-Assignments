...
score for a single word. The function get_word_score should accept as
input a string of lowercase letters (a word) and return the integer
...
def get_word_score(word_input, len_exp):
    """
